...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const validActions = ["resumo_solicitacao", "analise_documentos", "sugestao_engenheiro", "analise_banco"];
...
Formato markdown.`;
    ...
    console.error("[INTERNAL] ai-assistant error:", e);
